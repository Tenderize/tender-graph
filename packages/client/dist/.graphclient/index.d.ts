...
export type TenderizerDay_orderBy = 'id' | 'date' | 'tenderizer' | 'tvl' | 'rewards' | 'shares';
...
export type Tenderizer_orderBy = 'id' | 'symbol' | 'name' | 'validator' | 'asset' | 'tvl' | 'shares' | 'stakes' | 'tenderizerDays';
export type Unlock = {
    id: Scalars['ID'];
    user: User;
    tenderizer: Tenderizer;
...
export type Unlock_orderBy = 'id' | 'user' | 'tenderizer' | 'amount' | 'maturity' | 'redeemed';
export type User = {
    id: Scalars['ID'];
...
export type User_orderBy = 'id' | 'stakes' | 'unlocks';
export type _Block_ = {
...
export type GetTenderizersQuery = {
    tenderizers: Array<(Pick<Tenderizer, 'id' | 'symbol' | 'name' | 'validator' | 'tvl' | 'shares'> & {
        asset: Pick<Asset, 'id'>;
        tenderizerDays: Array<Pick<TenderizerDay, 'id' | 'date' | 'tvl' | 'rewards' | 'shares'>>;
    })>;
};
export type GetTenderizerQueryVariables = Exact<{
    id: Scalars['ID'];
}>;
export type GetTenderizerQuery = {
    tenderizer?: Maybe<(Pick<Tenderizer, 'id' | 'symbol' | 'name' | 'validator' | 'tvl' | 'shares'> & {
        asset: Pick<Asset, 'id'>;
        tenderizerDays: Array<Pick<TenderizerDay, 'id' | 'date' | 'tvl' | 'rewards' | 'shares'>>;
    })>;
};
...
export type GetUserQuery = {
    user?: Maybe<(Pick<User, 'id'> & {
        stakes?: Maybe<Array<(Pick<Stake, 'id' | 'shares'> & {
            tenderizer: (Pick<Tenderizer, 'id' | 'validator' | 'symbol' | 'name'> & {
                asset: Pick<Asset, 'id'>;
            });
        })>>;
        unlocks?: Maybe<Array<(Pick<Unlock, 'id' | 'amount' | 'maturity' | 'redeemed'> & {
            tenderizer: (Pick<Tenderizer, 'id' | 'validator' | 'symbol' | 'name'> & {
                asset: Pick<Asset, 'id'>;
            });
        })>>;
