...
export class TenderSwap extends ethereum.SmartContract {
  ...
  try_newestUnlock(): ethereum.CallResult<TenderSwap__newestUnlockResultValue0Struct> {
    let result = super.tryCall(
      "newestUnlock",
      "newestUnlock():((uint256,uint128,uint128,uint256))",
      [],
    ...
    return ethereum.CallResult.fromValue(
      changetype<TenderSwap__newestUnlockResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  try_oldestUnlock(): ethereum.CallResult<TenderSwap__oldestUnlockResultValue0Struct> {
    let result = super.tryCall(
      "oldestUnlock",
      "oldestUnlock():((uint256,uint128,uint128,uint256))",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<TenderSwap__oldestUnlockResultValue0Struct>(
        value[0].toTuple(),
      ),
    );
  }
